...
prj_path = r"C:\Users\Lutharsanen\Documents\GitHub\DeepLearning2048\DQN-2048-master"
...
NB_STEPS_TRAINING = 200 # number of steps used for training the model
NB_STEPS_ANNEALED = 100 # number of steps used in LinearAnnealedPolicy()
